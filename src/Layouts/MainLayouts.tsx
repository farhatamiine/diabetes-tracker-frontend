...
import {selectUserProfile, setProfile} from "../redux/features/user/userSlice";
...
export default function MainLayouts() {
    ...
    useEffect(() => {
        ...
        console.log(secureLocalStorage.getItem("credentials"))
        if(secureLocalStorage.getItem("credentials") === null){
            navigate("/login")
        }else{
            dispatch(setCredentials(secureLocalStorage.getItem("credentials")))
            ...
            <div className="min-h-full">
                ...
                <div className="lg:pl-64 flex flex-col flex-1">
                    <div
                        ...
                        <span className="sr-only">Open user menu for </span>{profile?.firstName} {profile?.lastName}
                      </span>
                                            <ChevronDownIcon
